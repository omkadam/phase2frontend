    ...
    <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50">
      <div className="bg-white rounded-2xl p-8 text-center shadow-2xl max-w-md w-full">
        ...
        <p className="text-lg font-semibold mb-6">
          You reached <span className="text-blue-500">Level {level}</span>!
        </p>
        <button
          onClick={() => {
            const audio = new Audio("/sounds/click.mp3"); // ✅ Make sure this file exists in your /public/sounds folder
            audio.play();
            onClose();
          }}
